...
const omelette = createMenuItem('Omelette', 5, 'Breakfast');
const coffee = createMenuItem('Coffee', 3, 'Drink');
const countryFriedSteak = createmenuItem('Country Fried Steak', 15, 'Breakfast')

console.log(omelette, Coffee, countryFriedSteak);
...
function getReviewByIndex(revCollection, index) {
    return `${revCollection[index].name} gave the restaurant a ${revCollection[index].rating}, and their feedback was: ${revCollection[index].feddback}`;
  }
